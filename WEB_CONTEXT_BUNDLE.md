...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:web-20260906-opg37357-a01",
      "claims": [],
      "completed_at": null,
      ...
      "objective": "对固定 labeled planar graph G 和整数 m，构造并审计一个 existential-real/semialgebraic 候选编码，使其精确表达“G 存在一般位置直线可见性表示及一个至多 m 个顶点的 simple polygon obstacle”；证明编码的 soundness，并明确 unrestricted obstacle number 1 的 completeness 尚缺什么。",
      "obligation_graph_id": "graph:opg37357-initial-v1",
      ...
      "route_id": "route:one-obstacle-semialgebraic-encoding-v1",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:web-20260906-opg37357-a01",
      "graph_id": "graph:opg37357-initial-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:opg37357-bounded-polygon-encoding"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:opg37357-root",
          "statement": {
          ...
          "statement_sha256": "2b45bf24bd64b1e08bb5320c90396ff6d67b834db0c3bc8d39fd09e777e13128"
        },
        {
          "dependencies": [],
          "kind": "lemma",
          "obligation_id": "obligation:opg37357-bounded-polygon-encoding",
          "statement": {
            "formal_declaration": null,
            "language": "zh",
            "text": "对固定 labeled planar graph G 和整数 m，构造并审计一个 existential-real/semialgebraic 候选编码，使其精确表达“G 存在一般位置直线可见性表示及一个至多 m 个顶点的 simple polygon obstacle”；证明编码的 soundness，并明确 unrestricted obstacle number 1 的 completeness 尚缺什么。"
          },
          "statement_sha256": "68308f97652b9b505f308f82eb5141a1ccfa50d25dd9a71f5332476348fcafd1"
        }
      ],
      "root_obligation_id": "obligation:opg37357-root",
      "route_id": "route:one-obstacle-semialgebraic-encoding-v1"
    }
  ],
  "problem_contract": {
